...
class Voyageencours extends StatefulWidget {

  @override
  State<Voyageencours> createState() => _VoyageencoursState();
}

class _VoyageencoursState extends State<Voyageencours> {
  bool val2 = false;
    ...
    return Container(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 260,),
            // La premiere ligne des images du menu
            Row(
                mainAxisAlignment: MainAxisAlignment.center,
                crossAxisAlignment: CrossAxisAlignment.center,
              children: <Widget>[
                GestureDetector(
                 onTap: () {
                  ...
                  child: Image.asset('assets/chargement.png'),
                ),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.pushReplacementNamed(context, "/vcdepart");
                  },
                  child: Image.asset('assets/aller.png'),
                ),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.pushReplacementNamed(context, "/vcarrive");
                  },
                  child: Image.asset('assets/retour.png'),
                ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: null, // c'est à ce niveau on gère ça
      body: Stack(
        children: <Widget> [
          picturetop(),
          /*Align(
